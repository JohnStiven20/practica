...
if (isset($_POST["nombre"])  && !empty($_POST["nombre"])) {
    ...
    if (mysqli_num_rows($res) > 0) {
        header("Location: ../admin/client/gestion_clientes.php?cli=1");
        exit;
    }

    $insert = "INSERT INTO clientes (nombre,apellidos,email,password,genero,direccion,codpostal,poblacion,provincia) VALUES ('$nombre','$apellidos','$email','$password','$genero','$direccion', '$codigo_postal','$provincia','$poblacion')";

    if (mysqli_query($con, $insert)) {
        header("Location:../admin/client/gestion_clientes.php?cli=0");
        exit;
    } else {
